...
acf_add_local_field_group( array(
    ...
    'fields'   => array(
        ...
        array( 'key' => 'field_ah_trust_badge_4', 'label' => 'Trust Badge 4', 'name' => 'trust_badge_4', 'type' => 'text', 'default_value' => 'Tracked, discreet delivery' ),
    ),
...
acf_add_local_field_group( array(
    ...
    'fields'   => array(
        array( 'key' => 'field_ah_top_banner_text', 'label' => 'Top Banner Text', 'name' => 'top_banner_text', 'type' => 'text', 'default_value' => 'GPhC-registered online pharmacy. Prescriber-reviewed care, delivered to your door —', 'instructions' => 'Advertise the service, never a prescription medicine by name or implication (ASA/MHRA/GPhC enforcement notice).' ),
        array( 'key' => 'field_ah_top_banner_link_text', 'label' => 'Top Banner Link Text', 'name' => 'top_banner_link_text', 'type' => 'text', 'default_value' => 'Check your eligibility' ),
...
acf_add_local_field_group( array(
    ...
    'fields'   => array(
        array( 'key' => 'field_ah_hero_eyebrow', 'label' => 'Eyebrow Text', 'name' => 'hero_eyebrow', 'type' => 'text', 'default_value' => 'Pharmacist-led. UK Registered.' ),
        ...
        array( 'key' => 'field_ah_hero_assurance', 'label' => 'Assurance Line (under the button)', 'name' => 'hero_assurance', 'type' => 'text', 'default_value' => 'Nothing is charged until a prescriber approves your treatment. Treatments from £99 a month, no subscription.', 'instructions' => 'The payment promise plus the entry price. Keep it true: the card is only held at assessment and released in full if declined.' ),
...
acf_add_local_field_group( array(
    ...
    'fields'   => array(
        array( 'key' => 'field_ah_hiw_eyebrow', 'label' => 'Eyebrow', 'name' => 'hiw_eyebrow', 'type' => 'text', 'default_value' => 'Simple, safe, supervised' ),
...
acf_add_local_field_group( array(
    ...
    'fields'   => array(
        ...
        array( 'key' => 'field_ah_faq_subtitle', 'label' => 'Subtitle', 'name' => 'faq_subtitle', 'type' => 'text', 'default_value' => 'Everything you need to know before you start.' ),
...
acf_add_local_field_group( array(
    ...
    'fields' => array(
        ...
        array( 'key' => 'field_ah_hiw_step2_badge', 'label' => 'Step 2 Badge', 'name' => 'hiw_step2_badge', 'type' => 'text', 'default_value' => 'Full clinical review' ),
        ...
        array( 'key' => 'field_ah_hiw_step3_badge', 'label' => 'Step 3 Badge', 'name' => 'hiw_step3_badge', 'type' => 'text', 'default_value' => 'Discreet, tracked delivery' ),
        ...
        array( 'key' => 'field_ah_hiw_trust2', 'label' => 'Trust Point 2', 'name' => 'hiw_trust2', 'type' => 'text', 'default_value' => 'Prescriber review included at every reorder' ),
...
acf_add_local_field_group( array(
    ...
    'fields' => array(
        array( 'key' => 'field_ah_cta_eyebrow', 'label' => 'Eyebrow', 'name' => 'cta_eyebrow', 'type' => 'text', 'default_value' => 'Start Today' ),
        ...
        array( 'key' => 'field_ah_cta_trust4', 'label' => 'Trust 4', 'name' => 'cta_trust4', 'type' => 'text', 'default_value' => 'No charge unless approved' ),
    ),
    'location' => array(
...
acf_add_local_field_group( array(
    ...
    'fields' => array(
        ...
        array( 'key' => 'field_ah_tr_mounjaro_price', 'label' => 'Mounjaro Price (e.g. "from £XX")', 'name' => 'tr_mounjaro_price', 'type' => 'text', 'default_value' => '', 'instructions' => 'Leave blank to hide the price line.' ),
        ...
        array( 'key' => 'field_ah_tr_wegovy_price', 'label' => 'Wegovy Price (e.g. "from £XX")', 'name' => 'tr_wegovy_price', 'type' => 'text', 'default_value' => '', 'instructions' => 'Leave blank to hide the price line.' ),
