            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-10 lg:gap-8 mb-14">
                ...
                <div>
                    ...
                    <ul class="space-y-3.5">
                        ...
                        <li><a href="<?php echo esc_url( get_permalink( get_page_by_path( 'wegovy-tablets' ) ) ); ?>" class="text-[15px] text-gray-300 hover:text-white transition-colors">Wegovy Tablets</a></li>
                        <li><a href="<?php echo esc_url( get_permalink( get_page_by_path( 'foundayo' ) ) ); ?>" class="text-[15px] text-gray-300 hover:text-white transition-colors">Foundayo</a></li>
                ...
                <div class="col-span-2 sm:col-span-3 lg:col-span-2">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center gap-3">
                            <div class="w-9 h-9 rounded-lg bg-white/[0.05] border border-white/[0.06] flex items-center justify-center flex-shrink-0">
