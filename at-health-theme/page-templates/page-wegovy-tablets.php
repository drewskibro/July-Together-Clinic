<?php
/**
 * Template Name: Wegovy Tablets
 * Description: Wegovy Tablets (oral semaglutide) product page.
 */
get_header();
?>
...
<div style="background:#fdf8f3;" class="border-b border-gray-200/50 py-4">
  <div class="max-w-7xl mx-auto px-6">
    <div class="flex items-center gap-2 text-sm text-gray-500">
      ...
      <span class="text-gray-300">/</span>
      <span class="text-gray-900 font-medium">Wegovy Tablets</span>
    </div>
  </div>
</div>
    ...
    <div class="grid lg:grid-cols-2 gap-12 items-start">
      <div data-reveal>
        <div class="flex items-center gap-3 mb-5">
          ...
          <p class="text-purple-600 text-xs font-bold uppercase tracking-wider"><?php echo esc_html( ah_field( 'wt_eyebrow', 'Semaglutide · Once-Daily Tablet' ) ); ?></p>
        </div>
        ...
        <div class="flex items-center gap-2 mb-4">
          ...
          <span class="text-sm text-gray-500"><?php echo esc_html( ah_field( 'wt_rating_text', 'The same trusted semaglutide — now needle-free' ) ); ?></span>
        </div>
        ...
        <div class="space-y-3 mb-8">
          ...
          $acf_benefits = ah_field( 'wt_benefits', '' );
      ...
      <div data-reveal="right">
        <div class="bg-white rounded-3xl border border-gray-200 overflow-hidden shadow-lg">
          <?php
          $wt_image = ah_field( 'wt_product_image', '' );
          if ( $wt_image ) :
          ...
          <div class="p-8">
            <div class="flex items-baseline gap-2 mb-4">
              ...
              <span class="text-4xl font-serif text-gray-900">&pound;<?php echo esc_html( ah_field( 'wt_price', '99' ) ); ?></span>
              <span class="text-gray-500 text-sm">/month</span>
            </div>
            <p class="text-sm text-gray-500 mb-6"><?php echo esc_html( ah_field( 'wt_price_includes', 'Includes medication, consultations & support · 30-day supply' ) ); ?></p>
            <a href="<?php echo esc_url( ah_booking_url() ); ?>" class="w-full flex items-center justify-center gap-2 bg-purple-600 hover:bg-purple-700 text-white text-base font-semibold px-8 py-4 rounded-xl shadow-lg hover:shadow-xl transition-all hover-lift">
              <?php echo esc_html( ah_field( 'wt_cta_text', 'Start Journey →' ) ); ?>
            </a>
...
<section class="py-14 md:py-16" style="background: #f7f4f9;">
  <div class="ah-container-wide">
    <div class="text-center mb-12 section-header">
      <div class="flex items-center justify-center gap-3 mb-4">
        <div class="w-1 h-8 bg-purple-600 rounded-full"></div>
        <p class="text-purple-600 text-xs md:text-sm font-bold uppercase tracking-wider"><?php echo esc_html( ah_field( 'wt_dosing_eyebrow', 'Gradual & Personalised' ) ); ?></p>
      </div>
      <h2 class="text-3xl md:text-4xl lg:text-5xl text-gray-800 font-serif leading-[1.1] mb-4">
        <?php echo wp_kses_post( ah_field( 'wt_dosing_title', 'How Wegovy Tablet Dosing Works' ) ); ?>
      </h2>
      <p class="text-base md:text-lg text-gray-700 leading-[1.7] max-w-2xl mx-auto">
        <?php echo esc_html( ah_field( 'wt_dosing_subtitle', 'One tablet a day, gradually increased across four dose strengths under clinical supervision. Every supply covers 30 days.' ) ); ?>
      </p>
    </div>
    <div class="max-w-3xl mx-auto space-y-6" data-stagger>
      ...
      <div class="wt-dosing-step flex items-start gap-4" data-reveal style="--stagger-index:<?php echo (int) $i; ?>">
    ...
    <div class="max-w-3xl mx-auto mt-8 bg-purple-50 border border-purple-200 rounded-2xl p-6" data-reveal>
      <p class="text-sm text-purple-800"><strong>Important: Personalised Dosing</strong> — <?php echo esc_html( ah_field( 'wt_dosing_note', 'Not everyone needs the maximum dose. Your prescriber will recommend the tablet strength that suits your response, and can adjust it at each reorder.' ) ); ?></p>
    </div>
  </div>
</section>
...
<section class="py-14 md:py-16" style="background: #fdf8f3;">
  <div class="ah-container-wide">
    <div class="text-center mb-12">
      <h2 class="text-3xl md:text-4xl font-serif text-gray-900 mb-4"><?php echo wp_kses_post( ah_field( 'wt_faq_title', 'Wegovy Tablets FAQs' ) ); ?></h2>
    </div>
...
<section class="relative py-20 md:py-28 overflow-hidden" style="background: #0f1117;">
  ...
  <div class="max-w-4xl mx-auto px-6 text-center relative z-10" data-reveal>
    <p class="text-[11px] font-bold uppercase tracking-[0.28em] text-gray-500 mb-6"><?php echo esc_html( ah_field( 'wt_cta_eyebrow', 'Start Today' ) ); ?></p>
    ...
    <div class="flex flex-wrap items-center justify-center gap-x-8 gap-y-3 border-t border-white/[0.07] pt-8">
      <?php foreach ( array( 'From £99/month', 'No needles', 'Delivered within 48 hours', 'Cancel anytime' ) as $t ) : ?>
