...
<!-- Treatment Showcase (with What's Included) -->
<!-- Moved from homepage Phase 2. Note: home_mounjaro_* and home_wegovy_* ACF fields are set on the homepage;
     defaults render here until fields are registered on this page. The hp-treatment-card CSS class uses
     the homepage prefix — rename to tr-treatment-card in a future cleanup pass. -->
